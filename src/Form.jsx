  ...
  return (
    <form onSubmit={handleSubmit} className='container w-50'>
      <div className='form-group row'>
        ...
        <div class="col-sm-10">
          <input type="text" id="name" className="form-control" name="name" value={formData.name} onChange={handleChange} required minLength={8}/>
        </div>
      </div>
      ...
      <div className='form-group row'>
        ...
        <div class="col-sm-10">
          <input type='text' id="description" className="form-control" name="description" value={formData.description} onChange={handleChange} required />
        </div>
      </div>
